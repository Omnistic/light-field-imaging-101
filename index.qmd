...
print('Number of centroids detected:', len(centroids))
```

The hard-coded threshold was chosen such that the number of centroids detected matched the expected 2&thinsp;729 from @sec-mla. 
...
fig['layout']['sliders'][0]['pad']=dict(r=80)
